...
class ReportBlockBottomSheet extends GetView<ReferFriendsController> {
  const ReportBlockBottomSheet({
    super.key,
  });
        ...
        child: Column(
          children: [
            ...
            commonContainer(
              ...
              title: "${LocaleKeys.app_report.tr} Sam",
            ...
            commonContainer(
              ...
              title: "${LocaleKeys.app_block.tr} Sam",
              subTitle: "Sam ${LocaleKeys.app_willNotBeNotifiedYouWant.tr}",
            ),
            SizedBox(
              height: 15.kh,
            ),
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  title ?? "",
                  style: TextStyleUtil.k16Semibold(fontSize: 16,fontWeight: FontWeight.w600),
...
class ReportBottomSheetScreen extends GetView<ReferFriendsController> {
  ReportBottomSheetScreen({
    super.key,
  });

  ReferFriendsController controller = Get.put(ReferFriendsController());
            ...
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    commonTextField(controller.somethingElseController),
                  ],
                )),
            GreenPoolButton(
              borderRadius: 50,
...
class ReportExplainIssue extends GetView<ReferFriendsController> {
  ReportExplainIssue({
    super.key,
  });

  ReferFriendsController controller = Get.find();
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            commonTextField(controller.explainIssueController),
...
class BlockBottomSheet extends GetView<ReferFriendsController> {
...
commonTextField(TextEditingController? controller){
  return TextField(
