...
class MessagesController extends GetxController {
 ...
 // final RxList<ChatRoom> chatRoomList = <ChatRoom>[].obs;
  final Rx<GroupChatRoomListModel> chatRoomList = GroupChatRoomListModel().obs;

  getChatRoomAPI() async {
      try {
        final response = await APIManager.getGroupChatRoomApi();
