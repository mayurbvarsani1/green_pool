...
class AddressDestinationView extends GetView<AddressDestinationController> {
  const AddressDestinationView({super.key});
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            Obx(
              () => Visibility(
                visible: controller.findLocationModels.isNotEmpty && !controller.hidePrevLoc.value,
                child: Column(
                          ...
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              onTap: () async {
                                ...
                                // Get.back(result: controller.postRideModel.value);
                              },
                            ),
                          );
                        }),
