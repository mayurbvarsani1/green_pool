...
// Call this when a place is selected to reset session
  ...
  void setLocationToFindRideController(List<dynamic> fetchLatLong) {
      Get.find<AddressesController>().riderOriginLat = fetchLatLong[0];
      Get.find<AddressesController>().riderOriginLong = fetchLatLong[1];
      Get.find<AddressesController>().riderOriginTextController.text = fetchLatLong[2];
